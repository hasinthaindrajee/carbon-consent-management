...
public abstract class ConsentsApiService {
    ...
    public abstract Response consentsPurposeEntityAssociationsAssociationIdDelete(String associationId);
    public abstract Response consentsPurposeEntityAssociationsAssociationIdGet(String associationId);
    public abstract Response consentsPurposeEntityAssociationsGet(String purposeId,String externalEntityName,String externalEntityType,Integer limit,Integer offset);
    public abstract Response consentsPurposeEntityAssociationsPost(PurposeEntityAssociationDTO purposeEntityAssociation);
