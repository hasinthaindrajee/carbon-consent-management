...
IF NOT EXISTS ( SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[CM_PURPOSE_EXT_ENTITY_ASSOC]') AND TYPE IN (N'U'))
CREATE TABLE CM_PURPOSE_EXT_ENTITY_ASSOC (
  ...
  TENANT_ID   INTEGER DEFAULT '-1234',
  CONSTRAINT CM_PURPOSE_EXT_ENTITY_ASSOC_CNT UNIQUE (PURPOSE_ID, EXTERNAL_ENTITY_NAME, EXTERNAL_ENTITY_TYPE),
  PRIMARY KEY (ID)
);
