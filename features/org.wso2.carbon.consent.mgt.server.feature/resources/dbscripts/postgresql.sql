...
DROP TABLE IF EXISTS CM_PURPOSE_EXT_ENTITY_ASSOC;
DROP SEQUENCE IF EXISTS CM_PURPOSE_ENTITY_ASSOC_PK_SEQ;
CREATE SEQUENCE CM_PURPOSE_ENTITY_ASSOC_PK_SEQ;
CREATE TABLE CM_PURPOSE_EXT_ENTITY_ASSOC (
  ID                    INTEGER DEFAULT NEXTVAL('CM_PURPOSE_ENTITY_ASSOC_PK_SEQ'),
  PURPOSE_ID            VARCHAR(255) NOT NULL,
  EXTERNAL_ENTITY_NAME  VARCHAR(255) NOT NULL,
  EXTERNAL_ENTITY_TYPE  VARCHAR(255) NOT NULL,
  TENANT_ID             INTEGER DEFAULT '-1234',
  UNIQUE KEY CM_PURPOSE_ENTITY_ASSOC_CNT (PURPOSE_ID, EXTERNAL_ENTITY_NAME, EXTERNAL_ENTITY_TYPE),
  PRIMARY KEY (ID)
);
